...
```bash
aws cloudformation create-stack --stack-name guile --template-body file://roman-numerals-template.yaml --parameters ParameterKey=KeyPairParameter,ParameterValue=guilex
```